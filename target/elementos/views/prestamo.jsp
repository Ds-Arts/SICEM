        ...
        <div id="central">
            <div id="login">
                ...
                <form action="Prestamo" method="post">
                    ...
                    <input class="formulario" type="text" id="cuentadante_fk" name="cuentadante_fk"   readonly placeholder="<%=request.getAttribute("id_cuentadante") %>" value="<%=request.getAttribute("id_cuentadante") %>">
